...
class WorkSchedulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cast_ids' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-17 23:30:56',
                'modified' => '2019-09-17 23:30:56'
            ],
        ];
        parent::init();
    }
