...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# article: http://ogp.me/ns/article#">
  ...
  ?>
    ...
    <meta property="og:image" content="<?=PUBLIC_DOMAIN.DS.$shop->top_image?>" />
  <?php 
    else:
  ?>
    <meta property="og:site_name" content="<?=LT['000']?>" />
    ...
    <meta property="og:image" content="<?=PUBLIC_DOMAIN.DS.PATH_ROOT['NIGHT_PLANET_IMAGE']?>" />
  <?php
    endif;
  ?>
...
<body id="user-default">
  <ul id="slide-out" class="side-nav fixed">
    ...
    <li><a class="waves-effect" href="/owner/login"><i class="material-icons">vpn_key</i><?= USER_LM['007'] ?></a></li>
  ...
  <footer class="page-footer">
    ...
    <div class="row">
      ...
      <div class="col s12 m6 l4"><div class="linkbox card-panel hoverable footer-item"><span><i class="material-icons">vpn_key</i><?= USER_LM['007'] ?></span><a class="" href="/owner/login"></a></div></div>
    </div>
    <div class="row">
      <div class="col s12">
