...
class NewsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'content' => ['type' => 'string', 'length' => 1200, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-11-13 01:00:16',
                'modified' => '2020-11-13 01:00:16'
            ],
        ];
        parent::init();
    }
