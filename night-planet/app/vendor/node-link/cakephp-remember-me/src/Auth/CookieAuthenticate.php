...
class CookieAuthenticate extends BaseAuthenticate
{
    ...
    protected $_defaultConfig = [
        ...
        'userModel' => 'Owers',// 使用するユーザーテーブルは、OwnersもUsersもある。
        'finder' => 'all',
        'scope' => [],
        'contain' => null,
    ];
     ...
     * データベースからユーザを操作するためのテーブルオブジェクトを取得します。
     ...
     * Cookieの値をデータベースからユーザーを取得するための条件に変換します。
     ...
     * cookieと設定に基づいてデータベースからユーザー情報を見つけます。
     * @param string|array $cookie
     * @return array|null
     */
     ...
     * 構成された認証クラスの1つを使用してユーザーが識別された後に発生します。
     * @param Event $event
     * @param array $user
     */
     ...
     * AuthComponent :: logout（）が呼び出されたときに発生します。
     * @param Event $event
     * @param array $user
     */
