...
<body id="shop-default">
  <ul id="slide-out" class="side-nav fixed">
    ...
    <li><a href="<?= in_array($this->request->getParam('action'), TAB_CONTROLE)?"/owner/shops/shopEdit":"#";?>" data-tab="top-image" class="waves-effect hoverable tab-click <?php if($role != 'owner'){echo "btn-disabled";}?>"><i class="material-icons">image</i><?= SHOP_LM['001'] ?></a></li>
    <li><a href="<?= in_array($this->request->getParam('action'), TAB_CONTROLE)?"/owner/shops/shopEdit":"#";?>" data-tab="catch" class="waves-effect hoverable tab-click <?php if($role != 'owner'){echo "btn-disabled";}?>"><i class="material-icons">mode_edit</i><?= SHOP_LM['002'] ?></a></li>
    <li><a href="<?= in_array($this->request->getParam('action'), TAB_CONTROLE)?"/owner/shops/shopEdit":"#";?>" data-tab="coupon" class="waves-effect hoverable tab-click <?php if($role != 'owner'){echo "btn-disabled";}?>"><i class="material-icons">stars</i><?= SHOP_LM['003'] ?></a></li>
    <li><a href="<?= in_array($this->request->getParam('action'), TAB_CONTROLE)?"/owner/shops/shopEdit":"#";?>" data-tab="cast" class="waves-effect hoverable tab-click <?php if($role != 'owner'){echo "btn-disabled";}?>"><i class="material-icons">group_add</i><?= SHOP_LM['004'] ?></a></li>
    <li><a href="<?= in_array($this->request->getParam('action'), TAB_CONTROLE)?"/owner/shops/shopEdit":"#";?>" data-tab="tenpo" class="waves-effect hoverable tab-click <?php if($role != 'owner'){echo "btn-disabled";}?>"><i class="material-icons">info_outline</i><?= SHOP_LM['005'] ?></a></li>
    <li><a href="<?= in_array($this->request->getParam('action'), TAB_CONTROLE)?"/owner/shops/shopEdit":"#";?>" data-tab="gallery" class="waves-effect hoverable tab-click <?php if($role != 'owner'){echo "btn-disabled";}?>"><i class="material-icons">photo_library</i><?= SHOP_LM['006'] ?></a></li>
    <li><a href="<?= in_array($this->request->getParam('action'), TAB_CONTROLE)?"/owner/shops/shopEdit":"#";?>" data-tab="job" class="waves-effect hoverable tab-click <?php if($role != 'owner'){echo "btn-disabled";}?>"><i class="material-icons">business_center</i><?= SHOP_LM['008'] ?></a></li>
    <li><a href="<?= in_array($this->request->getParam('action'), TAB_CONTROLE)?"/owner/shops/shopEdit":"#";?>" data-tab="sns" class="waves-effect hoverable tab-click <?php if($role != 'owner'){echo "btn-disabled";}?>"><i class="material-icons">chat_bubble_outline</i><?= SHOP_LM['010'] ?></a></li>
