<div class="sidebar col s12 m4 l4">
	<div class="section hide-on-med-and-down">
		...
		<div class="row sharer-modal">
			<div class="col l6">
				<a class="facebook sharer-btn waves-effect waves-light btn-large" href="<?=SHARER['FACEBOOK'].PUBLIC_DOMAIN?>">
					<span> Facebook</span>
				</a>
			</div>
			<div class="col l6">
				<a class="twitter sharer-btn waves-effect waves-light btn-large" href="<?=SHARER['TWITTER'].PUBLIC_DOMAIN?>">
					<span> Twitter</span>
				</a>
			</div>
		</div>
		<div class="row sharer-modal">
			...
			<div class="col l6">
				<a class="line sharer-btn waves-effect waves-light btn-large" href="<?=SHARER['LINE'].PUBLIC_DOMAIN?>">
					<span> LINE</span>
				</a>
			</div>
		</div>
