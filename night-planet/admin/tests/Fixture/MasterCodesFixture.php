...
class MasterCodesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'code_group' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'sort' => 1,
                'delete_flag' => 'L',
                'created' => '2019-02-10 16:47:02',
                'modified' => '2019-02-10 16:47:02'
            ],
        ];
        parent::init();
    }
