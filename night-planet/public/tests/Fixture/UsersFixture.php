...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'delete_flag' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status' => 1,
                'delete_flag' => 1,
                'created' => '2020-07-21 19:50:26',
                'modified' => '2020-07-21 19:50:26'
            ],
        ];
        parent::init();
    }
